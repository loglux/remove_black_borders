# remove_black_borders.py is a Python script that removes black borders from scanned images.
import cv2
import os
import numpy as np
...
def process_image(filename, input_folder, output_folder, target_width, target_height):
    ...
    if file_extension in supported_formats:
        ...
        if left_border is not None and right_border is not None:
            cropper.crop_image(input_path, left_border, right_border, output_folder, target_width, target_height)
